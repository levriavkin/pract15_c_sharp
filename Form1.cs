...
namespace pract15_c
{
    public partial class Form1 : Form
    {
        ...
        private void radioButton1_CheckedChanged(object sender, EventArgs e)
        {
            ...
            List<Complex> com2 = new List<Complex>();
            List<string> com3 = new List<string>();
            string[] s;
            ...
            for (int i = 0; i < dataGridView1.RowCount; i++)
            {
                ...
                {
                    dataGridView1[0, i].Value = com[i].r;
                    dataGridView1[1, i].Value = com[i].i;
                    dataGridView1[2, i].Value = com2[i].r;
                    dataGridView1[3, i].Value = com2[i].i;
                    Complex c1 = new Complex();
                    Complex c2 = new Complex();
